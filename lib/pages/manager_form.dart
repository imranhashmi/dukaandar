...
{
  @override
  State createState() => new ManagerFormState();
}

class ManagerFormState extends State<ManagerForm>
{
  TextEditingController nameController = new TextEditingController();
  TextEditingController descriptionController = new TextEditingController();

  void onAddPressed () {
    final item = new Manager(nameController.text, descriptionController.text);
